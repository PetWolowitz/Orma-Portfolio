  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-8">
        <h1 className="text-3xl sm:text-4xl md:text-5xl   text-center mb-8 sm:mb-12 text-gray-900 dark:text-white">
          Contact
        </h1>
        
        <div className="max-w-3xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 sm:p-8 md:p-10">
            <h2 className="text-xl sm:text-2xl  text-center mb-4 text-gray-900 dark:text-white">
              Get in Touch
            </h2>
