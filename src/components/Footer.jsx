  ...
  return (
    <footer className="py-6 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center space-y-4 mb-5">
          ...
          <div className="flex items-center space-x-6">
            ...
            <img
              src={Logo}
              alt="Logo"
              className="h-12 w-12" /* Dimensione del logo nel footer */
            ...
            >
              ...
              <svg
                className="h-10 w-10" /* Stessa dimensione del logo per coerenza */
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                <path
        ...
        {/* Testo Footer */}
        <p className="text-center text-xl font-stencil font-thin text-dark dark:text-white bg-primary-footer rounded-md p-2">
