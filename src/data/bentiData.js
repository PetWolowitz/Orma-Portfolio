  ...
  export const bentiItems = [
    {
      ...
      details: {
        ...
        projects: [
          ...
          {
            name: 'Murales della cantina sociale di Castenuovo Don Bosco',
            location: 'Cantina sociale di Castenuovo Don Bosco',
            description: 'Murale per la cantina sociale: un volto verde simbolo della vite, un albero con grappoli d’uva e case, che celebra il legame tra natura, vino e comunità.',
